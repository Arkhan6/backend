...
public class UserController {
	...
	public RestResponse saveOrUpdate(@RequestBody String userJson) throws JsonParseException, JsonMappingException, IOException {
		...
		if(!this.validate(user)) {
			return new RestResponse(HttpStatus.NOT_ACCEPTABLE.value(),"Los campos obligatorios no estan introducidos. nombre:"+ user.getFirstName()+" Apellido:"+user.getFirstSurname());
		}
